package io.github.motoryang.blog.gemini.controller;

import io.github.motoryang.blog.gemini.dto.ChatRequest;
import io.github.motoryang.blog.gemini.dto.GenerateBlogRequest;
import io.github.motoryang.blog.gemini.dto.GenerateSummaryRequest;
import io.github.motoryang.blog.gemini.service.GeminiAiRestService;
...
public class AiController {
    ...
    public RestResult<Map<String, Object>> generateBlog(@RequestBody GenerateBlogRequest request) {
        try {
            ...
            return RestResult.error(12001, "生成失败");
        }
    }
    ...
    public RestResult<Map<String, Object>> chat(@RequestBody ChatRequest request) {
        try {
            ...
            log.error("聊天失败", e);
            return RestResult.error(12001, "聊天失败");
        }
    }
